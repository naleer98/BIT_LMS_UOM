...
function Login() {
  ...
  const handleLogin = async (event) => {
    ...
    if (!formData.email.trim() || !formData.password.trim() || !formData.role) {
      alert("Please fill email, password, and role");
      return;
    }
          ...
          <div>
            ...
            <div className="mt-12">
              ...
              <h2 className="text-4xl md:text-5xl font-black leading-tight mt-3">
                Manage Learning with a Professional Digital Platform
              </h2>

              <p className="text-blue-100 leading-8 mt-6 text-lg">
                Access subject resources, quizzes, submissions, enrollments, and
                academic progress through the BIT Learning Management System.
              </p>
            </div>
            ...
            <div className="mt-10 grid sm:grid-cols-3 gap-4">
              <div className="bg-white/10 border border-white/15 rounded-2xl p-4 backdrop-blur-sm">
                ...
                <h3 className="font-black mt-3">Resources</h3>
              ...
              <div className="bg-white/10 border border-white/15 rounded-2xl p-4 backdrop-blur-sm">
                <p className="text-3xl">🧠</p>
                <h3 className="font-black mt-3">Quizzes</h3>
                <p className="text-blue-100 text-sm mt-1">
              ...
              <div className="bg-white/10 border border-white/15 rounded-2xl p-4 backdrop-blur-sm">
                <p className="text-3xl">📝</p>
                <h3 className="font-black mt-3">Submissions</h3>
                <p className="text-blue-100 text-sm mt-1">
                  Assignment tracking
                </p>
              </div>
        ...
        <div className="p-8 md:p-12 flex items-center">
          <div className="w-full max-w-md mx-auto">
            ...
            <p className="text-slate-500 leading-7 mt-4">
              Enter your registered account details to access your dashboard.
            </p>
            ...
            <p className="text-center text-slate-500 mt-6">
              New to BIT LMS?{" "}
              <Link to="/register" className="text-blue-700 font-black">
                Create Account
              </Link>
            </p>
